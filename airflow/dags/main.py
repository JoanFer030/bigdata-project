...
from bronze.tasks.ine.ine_renta import BRONZE_ine_renta_municipio, BRONZE_ine_renta_urls
...
def main_pipeline():
    ...
    urls = BRONZE_ine_renta_urls(year=ine_year)
    ine_renta_task = BRONZE_ine_renta_municipio(urls=urls)
