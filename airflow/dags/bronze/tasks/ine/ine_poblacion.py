...
@task
def BRONZE_ine_poblacion_municipio(year: int = 2023):
    """
    Load poblacion from INE datasource.
    ...
    print(f"[TASK] Starting INE Poblacion load for year {year} from {url}")
    ...
    msg = f"Successfully loaded INE Poblacion for year {year}: {row_count:,} records"
    print(f"[TASK] {msg}")
